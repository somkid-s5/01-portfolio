...
const ProjectCard = ({ project }: ProjectCardProps) => {
    ...
    return (
        <div
            className={`group relative overflow-hidden rounded-xl bg-[#0a0a0a] border border-white/5 ${styles.borderColor} transition-all duration-500 flex flex-col justify-between p-8 min-h-[300px] hover:shadow-2xl hover:shadow-${color}-500/10 hover:-translate-y-1`}
        >
