                        ...
                        <div className="glass-panel p-8 rounded-xl border-l-4 border-l-emerald-500 transition-all hover:bg-white/5">
                            ...
                            <ul className="space-y-3 text-gray-400 text-sm">
                                <li className="flex gap-3">
                                    ...
                                    Managed large-scale infrastructure combining Physical Servers
                                    (Fujitsu, HP) and Virtualization (VMware vCenter, Oracle
                                    LDOM).
                                </li>
                                <li className="flex gap-3">
                                    <span className="text-emerald-500 mt-1">▹</span>
                                    Automated backup & restore processes for Oracle Databases
                                    using RMAN/DataPump and Shell Scripts with Telegram alerts.
                                </li>
                                <li className="flex gap-3">
                                    <span className="text-emerald-500 mt-1">▹</span>
                                    Implemented Centralized Monitoring using Wazuh, Prometheus,
                                    and Grafana to ensure 99.9% system uptime.
                                </li>
                            </ul>
                        </div>
                    </div>
