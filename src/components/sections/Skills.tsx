        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-panel p-1 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="bg-gray-900 px-4 py-2 rounded-t-lg border-b border-gray-800 flex gap-2">
              ...
              <span className="ml-4 text-[10px] text-gray-500 font-mono truncate">
                root@smart-server:~/skills/infra
              </span>
            </div>
            <div className="p-4 sm:p-6 md:p-8 space-y-4 md:space-y-6">
              {[
                { name: 'Linux (Oracle/Ubuntu)', level: '95%' },
                ...
                <div key={index} className="group">
                  <div className="flex justify-between mb-1 text-[10px] md:text-sm font-mono text-gray-300">
                    <span>{skill.name}</span>
                    <span className="text-emerald-500">{skill.level}</span>
                  </div>
                  <div className="h-1 md:h-1.5 bg-gray-800 rounded-none overflow-hidden">
                    <div
