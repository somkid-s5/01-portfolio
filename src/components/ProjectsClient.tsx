            ...
            <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto min-h-screen">
                <div className="mb-12">
                    ...
                    <p className="text-gray-400 max-w-2xl text-lg">
                        Explore my complete portfolio of web applications, infrastructure automation, and security tools.
                    </p>
                </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors border ${!selectedCategory ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50' : 'bg-[#0a0a0a] text-gray-400 border-white/10 hover:border-white/30'}`}
                            >
                                All Categories
                            </button>
                            {categories.map(cat => (
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap transition-colors border ${selectedCategory === cat ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/50' : 'bg-[#0a0a0a] text-gray-400 border-white/10 hover:border-white/30'}`}
                                >
                                    {cat}
                                </button>
                            ))}
